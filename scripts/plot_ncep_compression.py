...
Run from the project root:
    python scripts/plot_ncep_compression.py

Output: plots/ncep_compression.pdf
"""
...
OUTFILE  = "plots/ncep_compression.pdf" # path relative to project root
TITLE    = "NCEP Air"
